...
export default function Home() {
  ...
  return (
    <>
      ...
      <h3 className=" mt-5 text-center HomeNoteTxt">{(notes.length!==0) && "Your Notes"}</h3>
      <div className="container d-flex mt-5 mb-5 flex-wrap align-items-center">
        <h4 className="text-center w-100">{(notes.length===0) && "Currently You have not created any note"}</h4>
        {notes.map((note) => {
